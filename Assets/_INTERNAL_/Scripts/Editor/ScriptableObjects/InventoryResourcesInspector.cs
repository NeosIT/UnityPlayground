...
{
	private string explanation = _("This is the list of Resources present in the game. Add and/or remove names here first, then go back to your Resource GameObjects and assign them a type.");
	...
	protected void OnEnable()
	{
		...
		list.drawHeaderCallback = (Rect rect) => {
			EditorGUI.LabelField(rect, _("Resource types"));
		};
	}
